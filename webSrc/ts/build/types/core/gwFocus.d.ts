...
export declare class GwFocus {
     ...
     * @returns {[DOMNodes]}
     */
    getFocusable(node: GwDomNode, allowNegativeTabIndex?: boolean): GwDomNodeList;
    /**
     * @private
     ...
     * @returns {boolean}
     */
    private canSelfBeFocusedBasedOnHtmlState(el, allowNegativeTabIndex?);
     ...
     */
    private focusableUsingTabIndex(el, allowNegativeTabIndex?);
     ...
     * @returns {boolean}
     */
    isFocusable(node: GwDomNode | null, allowChildren?: boolean, allowNegativeTabIndex?: boolean): boolean;
    /**
    ...
    processNewFocus(node: GwDomNode, animateOnFocus?: boolean, openParentMenusIfFocusTargetIsHidden?: boolean): void;
     ...
     */
    forceFocus(classIdOrNode: GwClassIdTagOrNode, animateOnFocus?: boolean, allowNegativeTabIndex?: boolean, openParentMenusIfFocusTargetIsHidden?: boolean): boolean;
