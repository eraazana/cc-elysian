...
export declare class GwNavigation extends GwRegisteredSystem {
     ...
     * @returns {*}
     */
    private abstractGetFocusableSibling(method, child, allowNegativeTabIndex?);
    /**
     * @public
     ...
     * @returns {DOM Element}
     */
    getNextFocusableSibling(child: GwDomNode, allowNegativeTabIndex?: boolean): GwDomNode | null;
    /**
     * @public
     ...
     * @returns {DOM Element}
     */
    getPrevFocusableSibling(child: GwDomNode, allowNegativeTabIndex?: boolean): GwDomNode | null;
    /**
     * @public
     ...
     */
    setFocusToClosestFocusableSelfOrParent(idOrNode: string | GwDomNode, allowNegativeTabIndex?: boolean): void;
}
