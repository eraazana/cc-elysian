package gw.webservice.cc.cc1000.contact
 ...
 */
@Export
@gw.xml.ws.annotation.WsiWebService( "http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/contact/ContactAPI" )
      ...
      if(bean typeis AddressBookLinkable or bean typeis AddressBookConvertable) {
        ...
        if(abuid!=null) {
          ...
          if(abuidProp.Accessor.getValue(bean)==null) {
            ...
            _logger.trace("Setting ABUID : ${abuid} on bean : ${bean.PublicID}")
            contactUpdated = true
          }
        }
      }
