...
uses com.guidewire.pl.system.entity.publicid.PublicIDGenerator
uses entity.Contact
...
uses gw.plugin.contact.ab5040.ContactDocumentsHelper
uses gw.plugin.contact.ab5040.ContactDocumentsSearchMapper
uses gw.plugin.contact.ab5040.ContactRequiredFieldMessageMapper
uses gw.plugin.contact.ab5040.ContactSearchMapper
uses gw.plugin.contact.ab5040.RelationshipSyncConfig
uses gw.plugin.contact.ab5040.RelationshipSyncConfigBase
...
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.AlreadyExecutedException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.DataConversionException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.EntityStateException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.PermissionException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.SOAPException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.faults.SOAPSenderException
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.types.complex.AddressBookUIDContainer
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.types.complex.RelatedContactInfoContainer
...
class ABContactSystemPlugin implements ContactSystemPlugin {
  ...
  private var _relSyncConfig : gw.plugin.contact.ab5040.RelationshipSyncConfigBase
  ...
  override function createContact(contact : Contact, transactionId:String) : ContactCreateResult {
    return handleErrors(null, contact, \->{
      ...
      var visitor = new gw.plugin.contact.ab5040.TemporaryIDContactVisitor()
  ...
  override function hasSyncableChanges(contact: Contact) : boolean {
    return handleErrors(null, contact, \ -> {
      ...
      if (contact.isFieldChanged(Contact#SourceRelatedContacts) || contact.isFieldChanged(Contact#TargetRelatedContacts) || contact.isFieldChanged(Contact#OfficialIDs)) {
        ...
        switch(eventName) {
          case CONTACT_ADDED_EVENT_NAME:
              if(ContactSystemApprovalUtil.shouldCreateInContactSystem(contact)) {
                ...
                var validationResult : wsi.remote.gw.webservice.ab.ab5040.abcontactapi.types.complex.ABContactAPIValidateCreateContactResult
                try {
  ...
  */
      ...
      override function visit(node: KeyableBean) {
        if (node typeis AddressBookLinkable) {
          if (node.ExternalLinkID == null && node.getFieldValue("AddressBookUID") == null) {
            node.ExternalLinkID = generateExternalLinkID()
          }
        }
      }
  ...
  private function generateExternalLinkID() : String {
    return PublicIDGenerator.generatePublicID(
        CCConfigParameters.ExternalLinkIDPrefix.Value,
        SequenceUtil.next(1, "CONTACT_EXTERNALLINKID")
    )
  }
  ...
  override function sendAsyncUpdate(message:Message, payload:String) {
    ...
    handleErrors(null, contact, \ -> {
      ...
      if(actionType typeis CreateAction) {
        ...
        var abXML = wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance.parse(contactXML)
   ...
   */
  private function removeContact(xml: wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance, id : String) {
   ...
   */
  private function getContactFromRemote(remoteXmlInstance:wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance, contact : Contact, bundle : Bundle) : Contact {
    if(contact == null) {
   ...
   */
  private function retrieveReplacementContact(addressBookId : String) : wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance {
    // check to see if this contact has been replaced with another one
    var remoteXmlBackedInstance : wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance
    var newABUID : String
    var api = ContactAPI
  ...
  private function _retrieveContact(abUID:String, contact : Contact, bundle : Bundle) : Contact {
    var remoteXmlInstance : wsi.remote.gw.webservice.ab.ab5040.beanmodel.XmlBackedInstance
