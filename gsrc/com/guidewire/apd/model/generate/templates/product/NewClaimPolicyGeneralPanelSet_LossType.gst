...
<PCF
  ...
  <PanelSet
    ...
    <DetailViewPanel
      ...
      <InputColumn>
        ...
        <DateInput
          ...
          required="true"
          validationExpression="Policy.EffectiveDate != null and Policy.ExpirationDate != null and Policy.ExpirationDate &lt; Policy.EffectiveDate ? DisplayKey.get(&quot;Java.Validation.AdminCatastrophe.Date.ForbidValidReverse&quot;) : null"
    ...
    <ListDetailPanel
      ...
      <PanelRef
        def="Editable${info.Product.Code}PolicyCoveragesLV(Policy)"
        editable="!Policy.Verified">
        <TitleBar
        ...
        <Toolbar>
          <IteratorButtons
            iterator="Editable${info.Product.Code}PolicyCoveragesLV.Editable${info.Product.Code}PolicyCoveragesLV"/>
        </Toolbar>
      </PanelRef>
      <PanelRef
